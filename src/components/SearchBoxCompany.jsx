  ...
  return (
    <div>
        <input
            ...
            value={searchUserBarValue}
            onChange={onChangeSearchUserBox}
            onKeyDown={onSearchKeyUserEnter}
            onFocus={props.focus}
            onBlur={props.blur}
        />
                        ...
                        <li className='bg-soft-basic border-1 p-2 italic'>Skills</li>
                            <div className='skill-div'>
                                {searchBarSkillsData.slice(0, 3).map((item) => {
                                    return <li className='searchResultList-item' onClick={ () => onClickedSearchUserItem({item: item, page:1}) } >{item}</li>
                                })}
                            </div>
                    </>                                   
                )}
